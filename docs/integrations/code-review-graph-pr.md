...
- [x] HTTPError from the dispatch (e.g. unregistered repo, 422) is soft-failed: the run still writes the JSON, prints `dispatch failed ... npx @looptech-ai/understand-quickly-cli add`, and exits 0.
